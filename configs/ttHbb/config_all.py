...
cfg = Configurator(
 ...
 f"{localdir}/datasets/WZ_2018.json"
        ...
        "filter" : {
            "samples": ["ttHToNonbb", "TTbbDiLeptonic_Powheg" , "TTbbSemiLeptonic_Powheg" , "TTbbHadronic_Powheg" , "THW" , "TTToSemiLeptonic_2018" , "TTTo2L2Nu" , "TTToHadronic" , "TTZToQQ" , "TTZtoLLNuNu" , "TTWJetsToQQ", "TTWJetsToLNu", "TTGJets" , "WW", "ZZ", "WZ" ],
            "samples_exclude" : [],
            "year": [year]
        } 
    },
