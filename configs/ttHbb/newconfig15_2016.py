...
cfg = Configurator(
    ...
    datasets = {
        "jsons": [ f"{localdir}/datasets/TTWJetsToLNu_2017.json",
f"{localdir}/datasets/ZJetsToQQ_HT800toInf_2017.json",
f"{localdir}/datasets/DYJetsToLL_M-50_2017.json",
f"{localdir}/datasets/TTToSemiLeptonic_2017.json",
f"{localdir}/datasets/TTToHadronic_2017.json",
f"{localdir}/datasets/TTTo2L2Nu_2017.json"
  ],
        "filter" : {
            "samples": ["TTWJetsToLNu", "ZJetsToQQ_HT800toInf" , "DYJetsToLL_M-50", "TTToSemiLeptonic", "TTToHadronic", "TTTo2L2Nu" ],
            "samples_exclude" : [],
            "year": ['2017']
        } # f"{localdir}/datasets/ZJetsToQQ_HT800toInf_2017.json",
    },
