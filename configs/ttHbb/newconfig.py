...
cfg = Configurator(
    ...
    datasets = {
        "jsons": [f"{localdir}/datasets/DATA_SingleMuon.json",
                  ...
                  f"{localdir}/datasets/DYJetsToLL_M-50_2018.json",
                  f"{localdir}/datasets/backgrounds_MC_TTbb_dileptonic.json",
                  f"{localdir}/datasets/signal_ttHTobb.json",
                  f"{localdir}/datasets/TTTo2L2Nu_2018.json",
                  f"{localdir}/datasets/TTToHadronic_2018.json",
                  f"{localdir}/datasets/TTToSemiLeptonic_2018.json",
                  f"{localdir}/datasets/TTWJetsToLNu_2018.json",
                  f"{localdir}/datasets/TTWJetsToQQ_2018.json",
                  f"{localdir}/datasets/TTZtoLLNuNu_2018.json",
                  f"{localdir}/datasets/TTZToQQ_2018.json",
                  f"{localdir}/datasets/WJetsToLNu_HT-200To400_2018.json",
                  f"{localdir}/datasets/WJetsToLNu_HT-400To600_2018.json",
                  f"{localdir}/datasets/WJetsToLNu_HT-600To800_2018.json",
                  f"{localdir}/datasets/WJetsToLNu_HT-800To1200_2018.json",
                  f"{localdir}/datasets/WJetsToLNu_HT-1200To2500_2018.json",
                  f"{localdir}/datasets/WJetsToLNu_HT-2500ToInf_2018.json",
                  ...
                  f"{localdir}/datasets/QCD_HT1500to2000_2018.json",
                  f"{localdir}/datasets/QCD_HT2000toInf_2018.json",
                  f"{localdir}/datasets/ST_s-channel_4f_leptonDecays_2018.json",
            ...
            "ZJetsToQQ_HT600to800": {
                "bycategory": {
                    "baseline": [
                        ...
                        ColOut("FatJetGood", ["eta", "pt", "phi", "mass", "msoftdrop", "tau1", "tau2", "tau3", "tau4", "deepTagMD_ZHbbvsQCD", "deepTagMD_ZHccvsQCD", "deepTagMD_HbbvsQCD", "deepTagMD_bbvsLight", "btagHbb"]),
                        ColOut("LeptonGood",["eta","pt","phi","pdgId"]),
                        ColOut("BJetGood", ["eta","pt","phi","btagDeepFlavB"]),
                        ColOut("BBFatJetGoodT", ["eta", "pt", "phi", "mass", "msoftdrop", "tau1", "tau2", "tau3", "tau4", "deepTagMD_ZHbbvsQCD", "deepTagMD_ZHccvsQCD", "deepTagMD_HbbvsQCD", "deepTagMD_bbvsLight", "btagHbb"]),
                        ColOut("BBFatJetGoodM", ["eta", "pt", "phi", "mass", "msoftdrop", "tau1", "tau2", "tau3", "tau4", "deepTagMD_ZHbbvsQCD", "deepTagMD_ZHccvsQCD", "deepTagMD_HbbvsQCD", "deepTagMD_bbvsLight", "btagHbb"]),
                        ColOut("BBFatJetGoodL", ["eta", "pt", "phi", "mass", "msoftdrop", "tau1", "tau2", "tau3", "tau4", "deepTagMD_ZHbbvsQCD", "deepTagMD_ZHccvsQCD", "deepTagMD_HbbvsQCD", "deepTagMD_bbvsLight", "btagHbb"])
                    ]
                }
            }
        }
