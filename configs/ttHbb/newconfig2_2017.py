...
cfg = Configurator(
    ...
    datasets = {
        "jsons": [f"{localdir}/datasets/TTGJets_2017.json",
                  f"{localdir}/datasets/THW_2017.json",
                  f"{localdir}/datasets/TTbbDiLeptonic_Powheg_2017.json"      ],
        "filter" : {
            "samples": ["TTGJets", "THW", "TTbbDiLeptonic" ],
            "samples_exclude" : [],
            "year": ['2017']
