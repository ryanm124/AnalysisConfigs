...
cfg = Configurator(
    ...
    datasets = {
        "jsons": [ f"{localdir}/datasets/TTWJetsToQQ_2018.json",
        ...
        "filter" : {
            "samples": ["TTWJetsToQQ","TTZtoLLNuNu","TTZToQQ","WJetsToLNu_HT-200To400","WJetsToLNu_HT-400To600","WJetsToLNu_HT-600To800"],
            "samples_exclude" : [],
            "year": ['2018']
        } 
    },
