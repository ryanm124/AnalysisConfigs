...
cfg = Configurator(
    ...
    datasets = {
        "jsons": [ f"{localdir}/datasets/{sample}_{year}.json"
              ],
        "filter" : {
            "samples": [sample],
            "samples_exclude" : [],
    ...
    columns = {
        "common": {
            "inclusive": [
                ...
                ColOut("MuonGood",["eta","pt","phi","jetRelIso","pfRelIso03_all", "miniPFRelIso_all" , "mvaTTH", "puppiIsoId" ]),
                ColOut("ElectronGood",["eta","pt","phi","jetRelIso", "pfRelIso03_all","miniPFRelIso_all", "mvaTTH" ]),                
